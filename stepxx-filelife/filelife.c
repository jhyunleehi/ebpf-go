...
#include "filelife.h"
#include "headers/core_fixes.bpf.h"
...
int kprobe_vfs_create(void *arg0, void *arg1, void *arg2) 
{
...
int kprobe_vfs_open(struct path *path, struct file *file)
{
...
int kprobe_security_inode_create(struct inode *dir, struct dentry *dentry)
{
	return probe_create(dentry);
}
...
int kprobe_vfs_unlink( void *arg0, void *arg1, void *arg2)
{
	u64 id = bpf_get_current_pid_tgid();
	struct event event = {};
